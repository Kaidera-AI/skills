...
kaidera:
  ...
  source:
    ...
    path: .agents/skills/penetration-testing-with-strix
    content_sha256: 91e19641a3169088ff04376bbed969b6e6f07e13cf269aad07e3f8cf253b50ee

author: Kaidera-AI
license: Apache-2.0
updated: 2026-09-05
tags: [penetration-testing, pentest, security, vulnerability, owasp, exploit, strix, sarif, appsec]
attribution_author: "usestrix"
attribution_url: "https://docs.strix.ai"
attribution_notes: "Wraps the open-source Strix autonomous-pentesting project (usestrix) and the managed app.strix.ai cloud; upstream docs at docs.strix.ai and docs.app.strix.ai."

safety_constraints:
  - "Only scan targets the user owns or has explicit written authorisation to test; never scan third-party or ambiguous infrastructure without documented permission."
  - "Confirm and record scope and authorisation before launching any scan - the cloud platform enforces domain verification, and for the OSS CLI the operator must verify authorisation themselves."
  - "Never hardcode, commit, log, or echo LLM keys or API tokens; read them from the environment or ask the user."
  - "Set an explicit spend cap (--max-budget for the CLI, or the plan budget for cloud), run scans in the background, and never treat a clean exit as full coverage without checking run status, cost against budget, and stated coverage."
  - "Active exploitation can disrupt live systems and expose secrets; prefer staging or the owner's informed consent, and do not exfiltrate, retain, or transmit discovered secrets or customer data."
---

<!-- GENERATED by scripts/skills/render-marketplace-skill.py from Kaidera-AI/kaideraos:.agents/skills/penetration-testing-with-strix (source content_sha256 91e19641a3169088ff04376bbed969b6e6f07e13cf269aad07e3f8cf253b50ee). Edit the source and re-render; never edit this file. -->
